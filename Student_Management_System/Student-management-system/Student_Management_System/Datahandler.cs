...
namespace Student_Management_System
{
    internal class Datahandler
    {
        ...
        public void AddStudent(Student student)
        {
            ...
            cmd = new SqlCommand($"INSERT INTO StudentDetails VALUES ('{student.StudentNumber}','{student.Name}','{student.Surname}','{student.Image}','{student.DateOfBirth}','{student.Gender}','{student.Phone}','{student.Address}','{student.ModuleCode}')", cnn);
            cmd.ExecuteNonQuery();
        ...
        public void UpdateStudent(Student student)
        {
            ...
            cmd = new SqlCommand($"UPDATE StudentDetails SET StudentName='{student.Name}', StudentSurname='{student.Surname}', DateOfBirth='{student.DateOfBirth}', Gender='{student.Gender}', Phone={student.Phone}, Adress='{student.Address}', ModuleCode='{student.ModuleCode}' WHERE StudentNumber='{student.StudentNumber}'", cnn);
            cmd.ExecuteNonQuery();
        ...
        public void UpdateModule(Modules module)
        {
            ...
            cmd = new SqlCommand($"UPDATE StudentModules SET ModuleName='{module.Name}', StudentSurname='{module.Description}', ModuleDescription='{module.Description}', Links='{module.Links}'", cnn);
            cmd.ExecuteNonQuery();
